...
#define JITIKE_CFG_NAME "jitike"

typedef struct private_jitike_tunnel_t private_jitike_tunnel_t;
typedef struct jitike_backend_t jitike_backend_t;
typedef struct jitike_creds_t jitike_creds_t;

/**
 * Serves credentials for the HA SA
 */
struct jitike_creds_t {
...
/**
 * Private data of an jitike_tunnel_t object.
 */
struct private_jitike_tunnel_t {

	/**
	 * Public jitike_tunnel_t interface.
	 */
	jitike_tunnel_t public;
	 ...
	 * backend for HA SA
	 */
	jitike_backend_t backend;

	/**
	 * credential set for HA SA
	 */
	jitike_creds_t creds;
};

METHOD(jitike_tunnel_t, is_sa, bool,
	private_jitike_tunnel_t *this, ike_sa_t *ike_sa)
{
...
METHOD(jitike_creds_t, create_shared_enumerator, enumerator_t*,
	jitike_creds_t *this, shared_key_type_t type,
...
METHOD(backend_t, create_peer_cfg_enumerator, enumerator_t*,
	jitike_backend_t *this, identification_t *me, identification_t *other)
{
	return enumerator_create_single(this->cfg, NULL);
}

METHOD(backend_t, create_ike_cfg_enumerator, enumerator_t*,
	jitike_backend_t *this, host_t *me, host_t *other)
{
 ...
 */
static void setup_tunnel(private_jitike_tunnel_t *this,
						 char *local, char *remote, char *secret)
{
	...
	peer_cfg = peer_cfg_create(JITIKE_CFG_NAME, ike_cfg, &peer);
	...
	child_cfg = child_cfg_create(JITIKE_CFG_NAME, &child);
	ts = traffic_selector_create_dynamic(IPPROTO_UDP, JITIKE_PORT, JITIKE_PORT);
...
METHOD(jitike_tunnel_t, destroy, void,
	private_jitike_tunnel_t *this)
{
	if (this->backend.cfg)
	{
	...
	charon->traps->uninstall(charon->traps, JITIKE_CFG_NAME, JITIKE_CFG_NAME);
	free(this);
}
