...
typedef struct private_jitike_attribute_t private_jitike_attribute_t;

/**
 * Private data of an jitike_attribute_t object.
 */
struct private_jitike_attribute_t {

	/**
	 * Public jitike_attribute_t interface.
	 */
	jitike_attribute_t public;
 ...
 */
static pool_t* get_pool(private_jitike_attribute_t *this, char *name)
{
 ...
 */
static bool responsible_for(private_jitike_attribute_t *this, int offset)
{
	u_int segment;
...
METHOD(attribute_provider_t, acquire_address, host_t*,
	private_jitike_attribute_t *this, linked_list_t *pools, ike_sa_t *ike_sa,
	host_t *requested)
{
	enumerator_t *enumerator;
	pool_t *pool = NULL;
...
METHOD(attribute_provider_t, release_address, bool,
	private_jitike_attribute_t *this, linked_list_t *pools, host_t *address,
	ike_sa_t *ike_sa)
{
	enumerator_t *enumerator;
	pool_t *pool;
...
METHOD(jitike_attribute_t, reserve, void,
	private_jitike_attribute_t *this, char *name, host_t *address)
{
	pool_t *pool;
	int offset;
...
METHOD(jitike_attribute_t, destroy, void,
	private_jitike_attribute_t *this)
{
 ...
 */
static void load_pools(private_jitike_attribute_t *this)
{
	enumerator_t *enumerator;
	char *name, *net, *bits;
	host_t *base;
