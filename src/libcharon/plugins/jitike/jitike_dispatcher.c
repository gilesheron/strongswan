...
typedef struct private_jitike_dispatcher_t private_jitike_dispatcher_t;
typedef struct jitike_diffie_hellman_t jitike_diffie_hellman_t;

/**
 * Private data of an jitike_dispatcher_t object.
 */
struct private_jitike_dispatcher_t {

	/**
	 * Public jitike_dispatcher_t interface.
	 */
	jitike_dispatcher_t public;
 ...
 */
struct jitike_diffie_hellman_t {
...
METHOD(diffie_hellman_t, dh_get_shared_secret, bool,
	jitike_diffie_hellman_t *this, chunk_t *secret)
{
...
METHOD(diffie_hellman_t, dh_get_my_public_value, bool,
	jitike_diffie_hellman_t *this, chunk_t *value)
{
 ...
 */
static diffie_hellman_t *jitike_diffie_hellman_create(chunk_t secret, chunk_t pub)
{
	jitike_diffie_hellman_t *this;
 ...
 */
static void process_ike_add(private_jitike_dispatcher_t *this, jitike_message_t *message)
{
	jitike_message_attribute_t attribute;
	jitike_message_value_t value;
	...
	if (ike_sa)
	{
		...
		dh = jitike_diffie_hellman_create(secret, dh_local);
 ...
 */
static void process_ike_update(private_jitike_dispatcher_t *this,
							   jitike_message_t *message)
{
	jitike_message_attribute_t attribute;
	jitike_message_value_t value;
	enumerator_t *enumerator;
	...
	while (enumerator->enumerate(enumerator, &attribute, &value))
	{
		if (attribute != JITIKE_IKE_ID && ike_sa == NULL)
		{
 ...
 */
static void process_ike_mid(private_jitike_dispatcher_t *this,
							   jitike_message_t *message, bool initiator)
{
	jitike_message_attribute_t attribute;
	jitike_message_value_t value;
	enumerator_t *enumerator;
 ...
 */
static void process_ike_iv(private_jitike_dispatcher_t *this, jitike_message_t *message)
{
	jitike_message_attribute_t attribute;
	jitike_message_value_t value;
	enumerator_t *enumerator;
 ...
 */
static void process_ike_delete(private_jitike_dispatcher_t *this,
							   jitike_message_t *message)
{
	jitike_message_attribute_t attribute;
	jitike_message_value_t value;
 ...
 */
static void process_child_add(private_jitike_dispatcher_t *this,
							  jitike_message_t *message)
{
	jitike_message_attribute_t attribute;
	jitike_message_value_t value;
	...
	if (secret.len)
	{
		dh = jitike_diffie_hellman_create(secret, chunk_empty);
	}
	if (ike_sa->get_version(ike_sa) == IKEV2)
	{
		keymat_v2_t *keymat_v2 = (keymat_v2_t*)ike_sa->get_keymat(ike_sa);
 ...
 */
static void process_child_delete(private_jitike_dispatcher_t *this,
								 jitike_message_t *message)
{
	jitike_message_attribute_t attribute;
	jitike_message_value_t value;
 ...
 */
static void process_segment(private_jitike_dispatcher_t *this,
							jitike_message_t *message, bool take)
{
	jitike_message_attribute_t attribute;
	jitike_message_value_t value;
	enumerator_t *enumerator;
 ...
 */
static void process_status(private_jitike_dispatcher_t *this,
						   jitike_message_t *message)
{
	jitike_message_attribute_t attribute;
	jitike_message_value_t value;
 ...
 */
static void process_resync(private_jitike_dispatcher_t *this,
						   jitike_message_t *message)
{
	jitike_message_attribute_t attribute;
	jitike_message_value_t value;
 ...
 */
static job_requeue_t dispatch(private_jitike_dispatcher_t *this)
{
	jitike_message_t *message;
	jitike_message_type_t type;

	message = this->socket->pull(this->socket);
	type = message->get_type(message);
	if (type != JITIKE_STATUS)
	{
		DBG2(DBG_CFG, "received HA %N message", jitike_message_type_names,
...
METHOD(jitike_dispatcher_t, destroy, void,
	private_jitike_dispatcher_t *this)
{
	free(this);
}
