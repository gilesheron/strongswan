...
typedef struct private_jitike_kernel_t private_jitike_kernel_t;

/**
 * Private data of an jitike_kernel_t object.
 */
struct private_jitike_kernel_t {

	/**
	 * Public jitike_kernel_t interface.
	 */
	jitike_kernel_t public;
 ...
 */
static u_int hash2segment(private_jitike_kernel_t *this, uint64_t hash)
{
...
METHOD(jitike_kernel_t, get_segment, u_int,
	private_jitike_kernel_t *this, host_t *host)
{
	unsigned long hash;
	uint32_t addr;
...
METHOD(jitike_kernel_t, get_segment_spi, u_int,
	private_jitike_kernel_t *this, host_t *host, uint32_t spi)
{
	unsigned long hash;
	uint32_t addr;
...
METHOD(jitike_kernel_t, get_segment_int, u_int,
	private_jitike_kernel_t *this, int n)
{
	unsigned long hash;
 ...
 */
static void enable_disable(private_jitike_kernel_t *this, u_int segment,
 ...
 */
static segment_mask_t get_active(private_jitike_kernel_t *this, char *file)
{
	char buf[256];
...
METHOD(jitike_kernel_t, activate, void,
	private_jitike_kernel_t *this, u_int segment)
{
	enumerator_t *enumerator;
	char *file;
...
METHOD(jitike_kernel_t, deactivate, void,
	private_jitike_kernel_t *this, u_int segment)
{
	enumerator_t *enumerator;
	char *file;
 ...
 */
static void disable_all(private_jitike_kernel_t *this)
{
	enumerator_t *enumerator;
...
METHOD(jitike_kernel_t, destroy, void,
	private_jitike_kernel_t *this)
{
	free(this);
}
