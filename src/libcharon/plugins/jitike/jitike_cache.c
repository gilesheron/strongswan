...
typedef struct private_jitike_cache_t private_jitike_cache_t;

/**
 * Private data of an jitike_cache_t object.
 */
struct private_jitike_cache_t {

	/**
	 * Public jitike_cache_t interface.
	 */
	jitike_cache_t public;
...
typedef struct {
	...
	u_int segment;
	/* ADD message */
	jitike_message_t *add;
	/* list of updates UPDATE message */
	linked_list_t *updates;
	/* last initiator mid */
	jitike_message_t *midi;
	/* last responder mid */
	jitike_message_t *midr;
	/* last IV update */
	jitike_message_t *iv;
} entry_t;
 ...
 */
static entry_t *entry_create(jitike_message_t *add)
{
	entry_t *entry;
...
static void entry_destroy(entry_t *entry)
{
	entry->updates->destroy_offset(entry->updates,
									offsetof(jitike_message_t, destroy));
...
METHOD(jitike_cache_t, cache, void,
	private_jitike_cache_t *this, ike_sa_t *ike_sa, jitike_message_t *message)
{
	entry_t *entry;
...
METHOD(jitike_cache_t, delete_, void,
	private_jitike_cache_t *this, ike_sa_t *ike_sa)
{
	entry_t *entry;
 ...
 */
static void rekey_segment(private_jitike_cache_t *this, u_int segment)
{
	ike_sa_t *ike_sa;
	enumerator_t *enumerator;
	linked_list_t *list;
...
METHOD(jitike_cache_t, resync, void,
	private_jitike_cache_t *this, u_int segment)
{
 ...
 */
static job_requeue_t request_resync(private_jitike_cache_t *this)
{
	jitike_message_t *message;
	int i;
	...
	message = jitike_message_create(JITIKE_RESYNC);
...
METHOD(jitike_cache_t, destroy, void,
	private_jitike_cache_t *this)
{
...
jitike_cache_t *jitike_cache_create(jitike_kernel_t *kernel, jitike_socket_t *socket,
							jitike_tunnel_t *tunnel, bool sync, u_int count)
{
	private_jitike_cache_t *this;
